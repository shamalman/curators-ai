...
export default function InviteModal({ profileId, onClose }) {
  ...
  const shareCode = async () => {
    ...
    const text = note.trim()
      ...
      : "Join me on Curators!";
    const shareData = {
      title: "Curators Invite",
      text: `${text}\n\nInvite code: ${inviteCode}`,
      url: "https://curators-ai.vercel.app/signup",
    };
    if (navigator.share) {
        ...
        <div style={{ padding: "16px 22px 24px" }}>
          {loading ? (
            ...
            <div style={{ textAlign: "center", padding: "20px 0" }}>
              ...
              <div style={{ fontFamily: F, fontSize: 14, color: T.ink3 }}>No invite codes available right now.</div>
            </div>
          ) : (
            <>
              {/* Invite code display */}
              <div style={{
                ...
                <div style={{ fontFamily: MN, fontSize: 24, fontWeight: 700, color: T.ink, letterSpacing: ".06em" }}>{inviteCode}</div>
              </div>
              ...
              <div style={{ marginBottom: 16 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: 8 }}>
                  <span style={{ fontSize: 11, color: T.ink3, fontFamily: F }}>This note personalizes their onboarding AI</span>
