...
const REQUESTS_DATA = [
  { id: "r1", from: "Maria", handle: "@maria", text: "Best date night spot in SF that isn't too loud?", category: "restaurant", date: "2026-02-14T10:30:00", status: "new", aiDraft: "Based on your taste, I'd suggest **Bar Agricole** — great cocktails, relaxed vibe, not overwhelming. **Nopa** is another option if they want food too — the flatbread is perfect for sharing." },
  { id: "r2", from: "David", handle: "@david", text: "A book for someone who loved Parable of the Sower?", category: "book", date: "2026-02-13T16:00:00", status: "new", aiDraft: "You recommended Parable of the Sower as essential. For someone who loved it, Octavia Butler's **Kindred** is the natural next step. If they want something more recent, **The Fifth Season** by N.K. Jemisin has similar energy." },
  { id: "r3", from: "Jess", handle: "@jess", text: "Road trip playlist for a Big Sur drive?", category: "music", date: "2026-02-12T09:15:00", status: "new", aiDraft: "Your **Khruangbin — Con Todo El Mundo** is the definitive road trip album. I'd build a playlist starting there. Want me to create a shareable collection?" },
  { id: "r4", from: "Alex", handle: "@alex", text: "What's the best brunch in SF?", category: "restaurant", date: "2026-02-10T11:00:00", status: "replied", reply: "Tartine Manufactory — the morning bun is legendary. Go on a weekday to avoid the line.", repliedAt: "2026-02-10T14:30:00" },
  { id: "r5", from: "Sam", handle: "@sam", text: "Any TV show I should binge this weekend?", category: "tv", date: "2026-02-09T19:00:00", status: "auto", aiReply: "Based on Shamal's taste: **Severance** — don't read anything about it, just watch. Trust the process. Also **The Bear** Season 2 if you want something intense." },
];

const TASTE_DATA = [
  { id: 1, slug: "kin-khao", title: "Kin Khao", category: "restaurant", context: "Crab fried rice is the move. Go for lunch.", tags: ["Thai", "SF"], date: "2025-11-14", visibility: "public", revision: 2, earnableMode: "none", website: "https://www.kinkhao.com", phone: "+14154731513",
    revisions: [
      { rev: 2, date: "2025-12-01", change: "Updated: added lunch tip" },
      { rev: 1, date: "2025-11-14", change: "Created" },
    ]},
  { id: 2, slug: "parable-of-the-sower", title: "Parable of the Sower", category: "book", context: "If you only read one dystopian novel, make it this one.", tags: ["Sci-Fi"], date: "2025-10-02", visibility: "public", revision: 1, earnableMode: "none",
    revisions: [{ rev: 1, date: "2025-10-02", change: "Created" }] },
  { id: 3, slug: "bar-agricole", title: "Bar Agricole", category: "restaurant", context: "Best cocktail bar in the city. The daiquiri is perfect.", tags: ["Cocktails", "SF"], date: "2025-09-18", visibility: "public", revision: 1, earnableMode: "licensing", website: "https://www.baragricole.com", phone: "+14153551400",
    revisions: [{ rev: 1, date: "2025-09-18", change: "Created" }] },
  { id: 4, slug: "khruangbin-con-todo-el-mundo", title: "Khruangbin — Con Todo El Mundo", category: "music", context: "No skips. Perfect road trip album.", tags: ["Chill", "Road Trip"], date: "2025-08-22", visibility: "public", revision: 1, earnableMode: "none",
    revisions: [{ rev: 1, date: "2025-08-22", change: "Created" }] },
  { id: 5, slug: "hotel-san-cristobal", title: "Hotel San Cristóbal", category: "travel", context: "Worth every penny. Book the ocean suite.", tags: ["Baja", "Splurge"], date: "2025-07-10", visibility: "private", revision: 1, earnableMode: "licensing",
    revisions: [{ rev: 1, date: "2025-07-10", change: "Created" }] },
  { id: 6, slug: "nopa", title: "Nopa", category: "restaurant", context: "The flatbread with ham and gruyère. Open late.", tags: ["SF", "Late Night"], date: "2025-06-05", visibility: "public", revision: 3, earnableMode: "none", website: "https://www.nopasf.com", phone: "+14158648643",
    revisions: [
      { rev: 3, date: "2026-01-15", change: "Updated: late night note" },
      { rev: 2, date: "2025-08-20", change: "Added wine list mention" },
      { rev: 1, date: "2025-06-05", change: "Created" },
    ]},
  { id: 7, slug: "severance", title: "Severance", category: "tv", context: "Don't read anything about it, just watch.", tags: ["Thriller"], date: "2025-05-20", visibility: "public", revision: 1, earnableMode: "none",
    revisions: [{ rev: 1, date: "2025-05-20", change: "Created" }] },
  { id: 8, slug: "tartine-manufactory", title: "Tartine Manufactory", category: "restaurant", context: "The morning bun is legendary. Go on a weekday.", tags: ["Brunch", "SF"], date: "2025-04-12", visibility: "public", revision: 1, earnableMode: "none", website: "https://www.tartinemanufactory.com", phone: "+14154872600",
    revisions: [{ rev: 1, date: "2025-04-12", change: "Created" }] },
  { id: 9, slug: "eat-my-shoes-janice-kopeka", title: "Eat my Shoes — Janice Kopeka", category: "music", context: "Hypnotic deep house groover. Flow state on the dance floor.", tags: ["Deep House"], date: "2026-02-12", visibility: "public", revision: 1, earnableMode: "none",
    revisions: [{ rev: 1, date: "2026-02-12", change: "Created" }] },
  { id: 10, slug: "flour-water", title: "Flour + Water", category: "restaurant", context: "The pasta tasting menu is one of the best meals in SF.", tags: ["Italian", "Pasta"], date: "2026-02-09", visibility: "public", revision: 1, earnableMode: "subscriber_access", website: "https://www.flourandwater.com", phone: "+14158260399",
    revisions: [{ rev: 1, date: "2026-02-09", change: "Created" }] },
  { id: 11, slug: "thrunite-ti-mini", title: "ThruNite Ti Mini", category: "product", context: "Surprisingly powerful keychain flashlight. USB-C charging.", tags: ["EDC"], date: "2026-02-12", visibility: "private", revision: 1, earnableMode: "licensing",
    revisions: [{ rev: 1, date: "2026-02-12", change: "Created" }] },
  { id: 12, slug: "the-bear-season-2", title: "The Bear (Season 2)", category: "tv", context: "Episode 6 is one of the best single episodes ever.", tags: ["Drama"], date: "2026-02-07", visibility: "public", revision: 1, earnableMode: "none",
    revisions: [{ rev: 1, date: "2026-02-07", change: "Created" }] },
];
...
export default function CuratorsV2() {
  ...
  useEffect(() => {
    if (mode === "curator" && curatorTab === "myai" && !chatInitd.current) {
      ...
      setMessages([
        { role: "ai", text: `What's good? You've fed me ${n} things — ${cc["restaurant"] || 0} restaurants, ${cc["music"] || 0} music picks, plus books, TV, and travel.\n\nDrop a rec, paste a link, or ask me anything.` },
        { role: "ai", type: "requestAlert", count: 3 },
        { role: "ai", type: "gratuity", from: "Jessica", amount: 5, message: "Tried Kin Khao because of you — the crab fried rice was unreal. Thank you!", recTitle: "Kin Khao", recCategory: "restaurant", time: "2h ago" },
        { role: "ai", type: "gratuity", from: "Marcus", amount: 10, message: "Parable of the Sower wrecked me in the best way. Buying copies for friends now.", recTitle: "Parable of the Sower", recCategory: "book", time: "Yesterday" },
      ]);
    }
  }, [mode, curatorTab]);
  ...
  const send = () => {
    ...
    setTimeout(() => {
      const l = msg.toLowerCase(); let r;
      const isVis = subScreen === "ai";

      // IMPORTANT: Check specific multi-word phrases BEFORE single keywords
      // to prevent false matches

      // Subscriber requests (curator only) — check FIRST before "request" alone
      if (!isVis && (l.includes("request") || l.includes("subscriber"))) {
        r = `📩 **Requests — 3 pending**\n\n→ **@maria** asks: "Best date night spot in SF that isn't too loud?"\n  ↳ Category: Restaurants · Received 2 hours ago\n\n→ **@david** asks: "A book for someone who loved Parable of the Sower?"\n  ↳ Category: Books · Received yesterday\n\n→ **@jess** asks: "Road trip playlist for a Big Sur drive?"\n  ↳ Category: Music · Received 2 days ago\n\nI can draft responses based on your taste. Want me to tackle these?`;
      }
      // Radio / playlist
      else if (l.includes("radio") || l.includes("station") || l.includes("playlist")) {
        const m = items.filter(i => i.category === "music");
        r = isVis
          ? `🎧 **${profile.name}'s Radio**\n\nNow playing from ${m.length} curated picks:\n\n` + m.map(x => `♫ **${x.title}** — "${x.context}"`).join("\n\n") + `\n\nThis station blends ${profile.name}'s favorites with similar artists. Want a specific mood?`
          : `🎧 **Recents Radio**\n\nBuilding from your ${m.length} picks:\n\n` + m.map(x => `♫ ${x.title}`).join("\n") + `\n\n*Coming soon — your music data is ready.*`;
      }
      // Newest / recent
      else if (l.includes("newest") || l.includes("latest") || l.includes("recent") || l === "what's new") {
        const rec = items.slice(0, 4);
        r = `**Newest${isVis ? ` from ${profile.name}` : ""}:**\n\n` + rec.map(x => `${(CAT[x.category] || CAT.other).emoji} **${x.title}** — "${x.context}"`).join("\n\n") + `\n\nWant to dig into any of these?`;
      }
      // Most popular
      else if (l.includes("popular") || l.includes("most") || l.includes("top picks")) {
        r = `**${isVis ? profile.name + "'s" : "Your"} most popular:**\n\n🍽 **Kin Khao** — The one everyone asks about. Crab fried rice, lunch only.\n\n📺 **Severance** — Most shared rec. "Don't read anything, just watch."\n\n🎵 **Khruangbin — Con Todo El Mundo** — The go-to road trip album.\n\n📖 **Parable of the Sower** — The book rec that converts everyone.\n\nWant more from a specific category?`;
      }
      // Books — check before generic "what" questions
      else if (l.includes("book") || l.includes("read")) {
        const b = items.filter(i => i.category === "book");
        r = b.length ? `**Book recs:**\n\n` + b.map(x => `📖 **${x.title}** — "${x.context}"`).join("\n\n") + `\n\nWant something specific — sci-fi, nonfiction, page-turner?` : `No book recs yet.`;
      }
      // Music
      else if (l.includes("music") || l.includes("listen") || l.includes("album") || l.includes("song")) {
        const m = items.filter(i => i.category === "music");
        r = m.length ? `**Music picks:**\n\n` + m.map(x => `🎵 **${x.title}** — "${x.context}"`).join("\n\n") + `\n\nWant a specific mood or genre?` : `No music recs yet.`;
      }
      // Restaurants — check before generic "what" questions
      else if (l.includes("restaurant") || l.includes("eat") || l.includes("food") || l.includes("dinner") || l.includes("lunch") || l.includes("brunch")) {
        const re = items.filter(i => i.category === "restaurant");
        r = `**Restaurant recs:**\n\n` + re.slice(0, 4).map(x => `🍽 **${x.title}** — "${x.context}"`).join("\n\n");
        if (re.length > 4) r += `\n\n+${re.length - 4} more. Filter by vibe — date night, late night, brunch?`;
      }
      // Date night
      else if (l.includes("date") || l.includes("romantic")) {
        r = `For date night:\n\n🍽 **Bar Agricole** — "Best cocktail bar. The daiquiri is perfect." Not too loud, great vibe.\n\n🍽 **Flour + Water** — "Pasta tasting menu, one of the best meals in SF." Commit to it.\n\nBoth in SF. Need another city?`;
      }
      // TV / watch / binge
      else if (l.includes("tv") || l.includes("watch") || l.includes("show") || l.includes("binge")) {
        const tv = items.filter(i => i.category === "tv" || i.category === "film");
        r = tv.length ? `**What to watch:**\n\n` + tv.map(x => `📺 **${x.title}** — "${x.context}"`).join("\n\n") : `No TV recs yet.`;
      }
      // Travel
      else if (l.includes("travel") || l.includes("hotel") || l.includes("trip") && !l.includes("road trip")) {
        const tr = items.filter(i => i.category === "travel");
        r = tr.length ? tr.map(x => `✈️ **${x.title}** — "${x.context}"`).join("\n\n") : `No travel recs yet.`;
      }
      // Hidden gem
      else if (l.includes("hidden") || l.includes("underrated") || l.includes("sleeper")) {
        r = `Here's one most people miss:\n\n🍽 **Nopa** — "The flatbread with ham and gruyère. Open late." Rare for SF. Deep wine list.\n\nWant more hidden gems?`;
      }
      // Curator-only features
      else if (!isVis && (l.includes("share") && l.includes("rec"))) {
        r = `📤 **Share Recs**\n\nSuggested sends this week:\n\n` + items.slice(0, 3).map(x => `→ **${x.title}** — matches 12 subscribers interested in ${(CAT[x.category] || CAT.other).label.toLowerCase()}`).join("\n\n") + `\n\nApprove and I'll deliver to each subscriber.\n\n*Coming soon.*`;
      }
      else if (!isVis && (l.includes("deal") || l.includes("discount"))) {
        r = `🏷 **Deals — 2 active**\n\n→ **Kin Khao** — 15% off lunch through Feb 28 (OpenTable)\n→ **ThruNite Ti Mini** — $4 off on Amazon, now $22\n\nDraft a deals roundup for subscribers?\n\n*Coming soon.*`;
      }
      else if (!isVis && (l.includes("news") || l.includes("update"))) {
        r = `📰 **News — 4 updates**\n\n🎵 **Khruangbin** — North American tour, SF June 12 at the Greek\n🍽 **Bar Agricole** — Spring cocktail menu launching March 1\n📺 **Severance** — Season 3 confirmed, filming underway\n🍽 **Tartine** — New head baker, updated pastry lineup\n\nPush any of these to subscribers?\n\n*Coming soon.*`;
      }
      else if (!isVis && (l.includes("just tried") || l.includes("amazing") || l.includes("incredible") || l.includes("check out") || l.includes("go to") || l.includes("you need"))) {
        r = `Nice. Before I save it:\n\n→ What specifically stood out?\n→ Who would you send there?\n→ Tips — best time, what to order?`;
      }
      else if (!isVis && (l.includes("stats") || l.includes("what do i") || l.includes("summary"))) {
        r = `Your taste profile:\n\n🍽 ${cc["restaurant"] || 0} restaurants\n🎵 ${cc["music"] || 0} music\n📖 ${cc["book"] || 0} books\n📺 ${cc["tv"] || 0} TV\n✈️ ${cc["travel"] || 0} travel\n⚡ ${cc["product"] || 0} products\n\n${n} total. Your AI gets sharper with every rec you add.`;
      }
      // Default
      else if (isVis) {
        r = `${profile.name}'s strongest areas are SF restaurants (${cc["restaurant"] || 0} picks), music, and TV.\n\nWhat are you in the mood for? I can help narrow it down.`;
      } else {
        const isUrl = l.startsWith("http") || l.includes(".com/") || l.includes(".co/");
        r = isUrl
          ? `Scanning that link...\n\nGot it — I'll add this to your taste. What made you want to recommend it?`
          : `Is this something you'd recommend? Tell me:\n\n→ What is it?\n→ Why does it matter?\n→ Who's it for?`;
      }
      setTyping(false); setMessages(m => [...m, { role: "ai", text: r }]);
    }, 600 + Math.random() * 500);
  };
