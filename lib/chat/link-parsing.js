 ...
 * Capped at 800 chars of body_md to match the existing distill budget.
 */
export function buildRecFileContextBlock(recFile) {
  ...
  const truncatedBody = bodyMd.length > 800 ? bodyMd.slice(0, 800) + '...' : bodyMd;
