...
export const CAT = {
  ...
  listen: { emoji: "\u{1F3A7}", color: "#C27BA0", bg: "#C27BA018", label: "Listen" },
  read: { emoji: "\u{1F4C4}", color: "#8B8BDB", bg: "#8B8BDB18", label: "Read" },
  visit: { emoji: "\u{1F4CD}", color: "#6BAA8E", bg: "#6BAA8E18", label: "Visit" },
  get: { emoji: "\u{1F4E6}", color: "#6B9EC2", bg: "#6B9EC218", label: "Get" },
  wear: { emoji: "\u{1F45F}", color: "#C2956B", bg: "#C2956B18", label: "Wear" },
  play: { emoji: "\u{1F3AE}", color: "#8BC29B", bg: "#8BC29B18", label: "Play" },
