...
export const CAT = {
  ...
  listen: { emoji: "\u{1F3B5}", color: "#C27BA0", bg: "#C27BA018", label: "Listen" },
  read: { emoji: "\u{1F4D6}", color: "#8B8BDB", bg: "#8B8BDB18", label: "Read" },
  visit: { emoji: "\u{1F37D}", color: "#6BAA8E", bg: "#6BAA8E18", label: "Visit" },
  get: { emoji: "\u26A1", color: "#6B9EC2", bg: "#6B9EC218", label: "Get" },
