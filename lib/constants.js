...
// ── Category config ──
export const CAT = {
  watch: { emoji: "\u{1F4FA}", color: "#9B8BC2", bg: "#9B8BC218", label: "Watch" },
  listen: { emoji: "\u{1F3A7}", color: "#4A9EE0", bg: "#4A9EE018", label: "Listen" },
  read: { emoji: "\u{1F4D6}", color: "#E07060", bg: "#E0706018", label: "Read" },
  visit: { emoji: "\u{1F4CD}", color: "#6BAA8E", bg: "#6BAA8E18", label: "Visit" },
  get: { emoji: "\u{1F4E6}", color: "#D4845A", bg: "#D4845A18", label: "Get" },
  wear: { emoji: "\u{1F6CD}\uFE0F", color: "#E07B9B", bg: "#E07B9B18", label: "Wear" },
  play: { emoji: "\u26A1", color: "#E8C547", bg: "#E8C54718", label: "Play" },
  other: { emoji: "\u25C6", color: "#C2956B", bg: "#C2956B18", label: "Other" },
};
