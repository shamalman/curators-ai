...
${confirmations && confirmations.length > 0 ? `=== CONFIRMED TASTE OBSERVATIONS (curator-endorsed, include these verbatim) ===
${confirmations.map(c => `- [${c.type}] (${c.created_at})\n"${c.observation}"`).join('\n\n')}
=== END ===

These observations must appear in the generated Taste File. They are curator-confirmed and cannot be omitted or paraphrased.` : ''}
