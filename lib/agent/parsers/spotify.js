      ...
      if (mainHtml) {
        ...
        if (ogDesc) {
          ...
          if (artistFromOg) {
            ...
            console.log("[SPOTIFY] track: strategy C (og:description) filled artist", { artist: artistFromOg });
          } else {
            console.warn("[SPOTIFY] track: strategy C og:description present but no artist token", { ogDesc });
          }
        } else {
          console.warn("[SPOTIFY] track: strategy C main page fetched but no og:description");
        }
      } else {
        console.warn("[SPOTIFY] track: strategy C main page fetch returned null");
      }
    }
    if (items.length === 0) {
