...
const parsers = [spotify, appleMusic, googleMaps, youtube, letterboxd];
...
const implementedParsers = new Set(["spotify", "apple-music", "youtube", "google-maps", "letterboxd", "webpage"]);
