...
const parsers = [spotify, appleMusic, googleMaps, youtube, letterboxd, goodreads, soundcloud];
...
const implementedParsers = new Set(["spotify", "apple-music", "youtube", "google-maps", "letterboxd", "goodreads", "soundcloud", "webpage"]);
