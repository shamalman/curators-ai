...
const parsers = [spotify, appleMusic, googleMaps, youtube, letterboxd, goodreads];
...
const implementedParsers = new Set(["spotify", "apple-music", "youtube", "google-maps", "letterboxd", "goodreads", "webpage"]);
